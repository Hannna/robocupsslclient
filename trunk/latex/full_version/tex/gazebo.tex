...
jest rzędu $m^2$, gdzie $m$ określa ilość wierszy (ograniczeń) analizowanej macierzy,
	...
	Domyślnie  podczas symulacji modeli lub połączeń \textit{joints} wykorzystywane są  globalne wartości parametrów. Istnieje także możliwość określania wartości cfm i erp
